...
static Key keys[] = {
	...
	{ MODKEY,                       XK_h,          rioresize,              {0} },
	#endif // RIODRAW_PATCH
	{ MODKEY,                       XK_l,          togglebar,              {0} },
	#if TAB_PATCH
	{ MODKEY|ControlMask,           XK_l,          tabmode,                {-1} },
	#endif // TAB_PATCH
	...
	{ MODKEY,                       XK_h,          swapfocus,              {.i = -1 } },
	#endif // SWAPFOCUS_PATCH
	#if SWITCHCOL_PATCH
	{ MODKEY,                       XK_v,          switchcol,              {0} },
	#endif // SWITCHCOL_PATCH
	#if ROTATESTACK_PATCH
	{ MODKEY|Mod4Mask,              XK_t,          rotatestack,            {.i = +1 } },
	{ MODKEY|Mod4Mask,              XK_n,          rotatestack,            {.i = -1 } },
	#endif // ROTATESTACK_PATCH
	#if INPLACEROTATE_PATCH
	{ MODKEY|Mod4Mask,              XK_t,          inplacerotate,          {.i = +2 } }, // same as rotatestack
	{ MODKEY|Mod4Mask,              XK_n,          inplacerotate,          {.i = -2 } }, // same as reotatestack
	{ MODKEY|Mod4Mask|ShiftMask,    XK_t,          inplacerotate,          {.i = +1} },
	{ MODKEY|Mod4Mask|ShiftMask,    XK_n,          inplacerotate,          {.i = -1} },
	#endif // INPLACEROTATE_PATCH
	#if PUSH_PATCH || PUSH_NO_MASTER_PATCH
	{ MODKEY|ControlMask,           XK_t,          pushdown,               {0} },
	{ MODKEY|ControlMask,           XK_n,          pushup,                 {0} },
	...
	#if FLEXTILE_DELUXE_LAYOUT
	{ MODKEY|ControlMask,           XK_j,          rotatelayoutaxis,       {.i = +1 } },   /* flextile, 1 = layout axis */
	...
	{ MODKEY|Mod5Mask,              XK_j,          rotatelayoutaxis,       {.i = -1 } },   /* flextile, 1 = layout axis */
	...
	#if MAXIMIZE_PATCH
	{ MODKEY|ControlMask|ShiftMask, XK_s,          togglehorizontalmax,    {0} },
	{ MODKEY|ControlMask|ShiftMask, XK_b,          togglehorizontalmax,    {0} },
	{ MODKEY|ControlMask|ShiftMask, XK_t,          toggleverticalmax,      {0} },
	{ MODKEY|ControlMask|ShiftMask, XK_n,          toggleverticalmax,      {0} },
	...
	{ MODKEY|ShiftMask,             XK_j,          unfloatvisible,         {.v = &layouts[0]} },
	...
	#if STICKY_PATCH
	{ MODKEY|ShiftMask,             XK_h,          togglesticky,           {0} },
	#endif // STICKY_PATCH
	...
	{ Mod3Mask,                     XK_b,            floatpos,               {.v = " 26x   0y" } }, // →
	...
	{ Mod3Mask|ControlMask,         XK_b,            floatpos,               {.v = " 26a   0a" } }, // →
	...
	{ Mod3Mask|ShiftMask,           XK_n,            floatpos,               {.v = "800W 800H" } }, // ·
	{ Mod3Mask|ShiftMask,           XK_b,            floatpos,               {.v = " 26w   0h" } }, // →
	...
	{ Mod3Mask|Mod1Mask,            XK_n,            floatpos,               {.v = " 0p  0p" } }, // ·
	{ Mod3Mask|Mod1Mask,            XK_b,            floatpos,               {.v = " 1p  0p" } }, // →
